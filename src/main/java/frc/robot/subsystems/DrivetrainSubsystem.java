...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  public DrivetrainSubsystem() {
    m_frontLeftMotor  = new CANSparkMax(Constants.Drivetrain.kFrontLeftCanId, MotorType.kBrushless);
    ...
    m_frontRightMotor = new CANSparkMax(Constants.Drivetrain.kFrontRightCanId, MotorType.kBrushless);
    ...
    m_rearLeftMotor   = new CANSparkMax(Constants.Drivetrain.kRearLeftCanId, MotorType.kBrushless);
    ...
    m_rearRightMotor  = new CANSparkMax(Constants.Drivetrain.kRearRightCanId, MotorType.kBrushless);
