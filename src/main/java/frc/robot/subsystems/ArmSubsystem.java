...
public class ArmSubsystem extends SubsystemBase {
  ...
  public ArmSubsystem() {
    m_motor1 = new WPI_VictorSPX(Constants.Arm.kArm1CanId);
    m_motor1.setInverted(false);
    m_motor1.setNeutralMode(NeutralMode.Brake);

    m_motor2 = new WPI_VictorSPX(Constants.Arm.kArm2CanId);
     ...
     * m_motor.setSoftLimit(SoftLimitDirection.kForward, (float)
     * Constants.Arm.kSoftLimitForward);
     * m_motor.setSoftLimit(SoftLimitDirection.kReverse, (float)
     * Constants.Arm.kSoftLimitReverse);
     * 
     * // set up the motor encoder including conversion factors to convert to
     * radians
     * // and radians per
...
/*       m_setpoint = m_encoder.getPosition();
      ...
      m_motor1.set(_power*Constants.Arm.kArmPowerScale);
